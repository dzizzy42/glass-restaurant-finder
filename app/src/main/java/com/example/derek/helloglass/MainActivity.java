...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle bundle) {
        ...
        */
        ...
        cards.add(0, new CardBuilder(this, CardBuilder.Layout.TEXT).setText("Menu"));
        cards.add(1, new CardBuilder(this, CardBuilder.Layout.TEXT).setText("Reviews"));
        cards.add(2, new CardBuilder(this, CardBuilder.Layout.TEXT).setText("Hours"));
        cards.add(3, new CardBuilder(this, CardBuilder.Layout.TEXT).setText("JSON Test"));
